...
На схеме тикет проходит разбор в `needs-triage`.
...
Результатом становится готовый бриф, запрос уточнений или обоснованный отказ. После получения сведений тикет снова проходит проверку. Решение о переходе принимает мейнтейнер.
