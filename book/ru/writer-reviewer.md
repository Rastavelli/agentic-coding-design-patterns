...
flowchart LR
  ...
  diff["дифф + критерии<br/>план · спецификация · оси"]:::accent
  reviewer["Рецензент — свежий контекст<br/>отдельная сессия или сабагент<br/>видит только дифф и критерии<br/>находит — не правит"]
