...
каждый со своим взглядом на то, каким он должен быть. В этом разделе разобраны
три:
...
Инструментов заметно больше — GitHub Spec Kit (самый прямой перенос паттерна в
инструмент), Kiro, Tessl, BMAD и десятки других. Их обзор и сравнение собраны в
проекте [spec-compare](https://cameronsjo.github.io/spec-compare/); ссылки на
инструменты — в [полезных ссылках](resources.md).

## Пример

Задача: добавить в сервис экспорт отчётов по расписанию.

**Спецификация** (например, командой `/opsx:propose` в OpenSpec):
...
- [OpenSpec](openspec.md), [Superpowers](superpowers.md) и
  [скилы Мэтта Покока](matt-pocock-skills.md) — три решения, разобранных в
...
- Полный ландшафт инструментов SDD — GitHub Spec Kit, Kiro, Tessl,
  BMAD-Method (SDD в agile-обёртке с ролевыми агентами), Spec Kitty, Traycer и
  десятки других — собран в сравнении
  [spec-compare](https://cameronsjo.github.io/spec-compare/) и в
  [полезных ссылках](resources.md).
