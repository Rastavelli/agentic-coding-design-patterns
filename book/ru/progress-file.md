...
На схеме сессии связаны журналом и git-историей.
...
Перед завершением агент обновляет состояние, а следующий исполнитель читает его вместе с коммитами. Так он получает следующий шаг и может проверить фактическое состояние кода.
