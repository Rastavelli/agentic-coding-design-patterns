...
> Проверь каждое допущение этого плана. Сначала выясни зависимости решений. Независимые вопросы с уже известными предпосылками задавай небольшим раундом. Вопросы, зависящие от ещё не полученного ответа, оставляй на следующий раунд. Для каждого предлагай рекомендуемый ответ с обоснованием. Факты ищи в коде самостоятельно. Решения согласуй со мной и жди ответа. Начинай реализацию после подтверждения общего понимания.

При интервью придерживайтесь следующих правил.

- **Учитывайте зависимости.** Несколько независимых вопросов можно задать вместе. Если следующий вопрос зависит от ответа на предыдущий, дождитесь ответа. Размер раунда должен позволять разработчику разобрать все пункты.
...
2. Попросите проверить допущения и сгруппировать независимые вопросы. После ответов агент уточняет план и выбирает следующий раунд.
...
Независимый вопрос о корпоративных договорах можно включить в тот же раунд. Выбор даты пересчёта платежа зависит от правила даунгрейда, поэтому агент оставляет его до ответа разработчика.
...
- **Зависимые вопросы в одном раунде.** Поздний вопрос может предполагать ещё не принятое решение. Отложите его до ответа; длинный раунд независимых вопросов сократите, если часть пунктов остаётся без внимания.
