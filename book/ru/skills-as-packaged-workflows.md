...
На схеме повторяемая процедура становится версионируемым файлом.

```mermaid
---
title: скилл загружает процедуру по требованию
---
flowchart LR
  ...
  packs["паки скиллов<br/>готовые методологии вендорятся в проект набором"]:::muted
...
Пользователь вызывает её по имени или агент выбирает по описанию. Соседние справочные файлы дополняют конкретные шаги.
