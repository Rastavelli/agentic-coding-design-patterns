...
- Детали реализации остаются в коде и спецификациях.
...
```mermaid
---
title: один концепт — одно слово; у каждого решения записано «почему»
---
flowchart LR
...
- **Словарь-спецификация.** Имена таблиц и порядок вызовов быстро устаревают. Оставляйте в словаре смысл понятий, а реализацию описывайте в коде и спецификациях.
